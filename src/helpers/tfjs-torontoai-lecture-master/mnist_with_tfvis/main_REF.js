...
// ~~ while training, shows loss 
// ~~ intro confuse matrix = points where mistakes are made when training with parameters and layers
...
async function train( model, data ) {
  ...
  return model.fit( trainXs, trainYs, {
    // ~~ escape from local min with batchSize
